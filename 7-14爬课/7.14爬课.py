...
# print(lujing)
with open(lujing, 'w', encoding='utf-8', )as w:
    # f.write(html3)/这种可以的
                        ...
                        try:
                            ...
                            for f in data1:
                                # try:
                                    ...
                                    print(vid)
                                    # print('图片')
                                    # cover = ('https://open.oss.taozhi.cn/production/'+f['cover'])
                                    # print(cover)
                                    ...
                                    data=json.loads(html)
                                    data1=data['data']
                                    # coverURL = (re.findall('https[^\s]+jpg|https[^\s]+png',str(data1))[0])
                                    # print(coverURL)
                                    # # print('检测MP4')
                                    mp4 = (re.findall('https[^\s]+mp4|https[^\s]+mp3',str(data1))[0])
                                    print(mp4)
                                #
                                    # 制作单节课页面数据
                                    path = "首页/" + str(a['xdName'])  + str(a['gradeName']) + '/' + str(cename) + '/' + str(
